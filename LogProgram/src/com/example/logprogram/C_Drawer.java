...
public class C_Drawer extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {	
        ...
        setContentView(R.layout.c_drawer);
        ...
        if(status != ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            = (SupportMapFragment)getSupportFragmentManager().findFragmentById(R.id.c_drawer_map);
    ...
    private void initDrawerList(){
    	layDrawer = (DrawerLayout) findViewById(R.id.c_drawer_layout);
        lstDrawer = (ListView) findViewById(R.id.c_left_drawer);
        String[] drawer_menu = this.getResources().getStringArray(R.array.c_drawer_menu);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.c_drawer_list_item, drawer_menu);
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				switch((int)id)
				{
					...
					case 1:
						...
						break;
					case 2: 
						startActivity(new Intent(getApplicationContext(), C_Artificial_Return.class));
						break;
					case 3: /*SPC*/																	  
						break;
					case 4: 
						startActivity(new Intent(getApplicationContext(), C_Menu_Welcome.class)); 	  
						break;
					default:
						break;
				}
